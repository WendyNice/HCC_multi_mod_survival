...
def parse_opts():
    ...
    parser.add_argument(
        '--root_path', default='/home/amax/Wendy/classification_PyTorch_HCC_multi_mod', type=str, help='Root directory path of code')
    ############################################################
    parser.add_argument(
        '--data_root_path', default='/data/Wendy/HCC/MR_clf', type=str, help='Root directory path of data')
    parser.add_argument(
        '--result_path', default='/data/Wendy/HCC/MR_clf/result/test_1_year', type=str, help='Result directory path')
    ############################################################
    parser.add_argument(
        '--event_path', default='events', type=str, help='Result directory path')
    parser.add_argument(
        '--resume_path', default='/data/Wendy/HCC/MR_clf/result/net_model_fold2.pkl', type=str,
    ...
    parser.add_argument(
        '--learning_rate', default=0.05, type=float, help='Initial learning rate')
    parser.add_argument(
    ...
    parser.add_argument(
        '--sample_size1', default=100, type=int, help='width of inputs')   # the first shape
    parser.add_argument(
        '--sample_size2', default=100, type=int, help='Height of inputs')   # the third shape
    parser.add_argument(
        '--sample_duration', default=100, type=int, help='Temporal duration of inputs')  # the second shape
    parser.add_argument(
