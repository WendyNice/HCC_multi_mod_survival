...
extra_val_csv.to_csv(os.path.join(csv_path, 'extra_valid_fold_RFS_resample.csv'), header=False, index=False, sep=str(','))
...
extra_all_val_csv.to_csv(os.path.join(csv_path, 'extra_all_valid_fold_RFS_resample.csv'), header=False, index=False, sep=str(','))
