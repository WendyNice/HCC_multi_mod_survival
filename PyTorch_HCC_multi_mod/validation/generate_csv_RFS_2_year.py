...
# path_label = '/data/Wendy/HCC/MR_clf/label_RFS_resample'
path_label = '/data/Wendy/HCC/valid_set'
...
train_path = os.path.join(path, 'data_RFS_resample', 'train')
data_path_train = os.listdir(train_path)

test_path = os.path.join(path, 'data_RFS_resample', 'test')
...
test_csv.to_csv(os.path.join(csv_path, 'val_fold_RFS_resample.csv'), header=False, index=False, sep=str(','))
# val_csv.to_csv(os.path.join(csv_path, 'val_fold_RFS_resample.csv'), header=False, index=False, sep=str(','))
train_csv.to_csv(os.path.join(csv_path, 'train_fold_RFS_resample.csv'), header=False, index=False, sep=str(','))
...
all_csv.to_csv(os.path.join(csv_path, 'All_fold_RFS_resample.csv'), header=False, index=False, sep=str(','))
