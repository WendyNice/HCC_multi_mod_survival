...
data_train_name, data_test_name = train_test_split(name, test_size=0.3, random_state=33)
...
test_data_save = test_data_ori[['放射号', 'BCLC', '白蛋白（0>=35,1<35）.1', 'AST(1>35;0<=35).1', col_event, col_time]]
test_data_save = test_data_save.dropna(axis=0, how='any')
test_data_save.to_csv('/data/Wendy/HCC/clinical_dl/test_survival_clin.csv')
# print('test_data_save', test_data_save)
print(train_data.isnull().sum())
print(test_data.isnull().sum())

train_data_ori.to_csv(os.path.join('/data/Wendy/HCC/clinical_dl', 'train_clinic_rfs.csv'))
test_data_ori.to_csv(os.path.join('/data/Wendy/HCC/clinical_dl', 'test_clinic_rfs.csv'))
train_data = train_data.dropna(axis=0, how='any')
test_data = test_data.dropna(axis=0, how='any')
test_data = test_data.loc[test_data[col_time] >= 0]
train_data.to_csv('/data/Wendy/HCC/result/multi_variants/train_df_rfs.csv')
test_data.to_csv('/data/Wendy/HCC/result/multi_variants/test_df_rfs.csv')
...
# featrues_cox = ['BCLC'] + [col_event] + [col_time]
...
print('多因素cox result', cph.score(test_data, scoring_method="concordance_index"))
print('cph.AIC_partial_', cph.AIC_partial_)
